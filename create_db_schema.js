...
//create all tables
  Router.get('/',(req,res)=>{
    ...
    var admin="create table if not exists admin(adminid int primary key auto_increment,password varchar(20) not null,mobileno varchar(10),email varchar(50) not null);";
